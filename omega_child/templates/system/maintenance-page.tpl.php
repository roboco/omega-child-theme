...
<?php if (omega_extension_enabled('compatibility') && omega_theme_get_setting('omega_conditional_classes_html', TRUE)): ?>
  ...
  <!--[if (gte IE 9)|(gt IEMobile 7)]><html class="no-js ie" lang="<?php print $language->language; ?>" dir="<?php print $language->dir; ?>"<?php if(isset($rdf_namespaces)) { print $rdf_namespaces; } ?>><![endif]-->
  <!--[if !IE]><!--><html class="no-js" lang="<?php print $language->language; ?>" dir="<?php print $language->dir; ?>"<?php if(isset($rdf_namespaces)) { print $rdf_namespaces; } ?>><!--<![endif]-->
<?php else: ?>
...
<body<?php print $attributes;?> style="background-color:white">
...
<div style="width:100%; display:block;">
  ...
  <div class="l-main">
     <div class="l-branding" style="padding:20px 0 10px 20px;float:left">
      <?php if ($logo): ?>
        <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" class="site-logo">&nbsp;</a>
      <?php endif; ?>
      </div>
    <div class="l-content" role="main" style="float:left; margin:40px 20px;">
          <?php print $messages; ?>
           <?php print $content; ?>
    </div>
  </div>
